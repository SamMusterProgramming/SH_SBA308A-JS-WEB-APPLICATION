...
function getUpdate() {
  _axios.default.get("https://api.nasa.gov/planetary/earth/assets?lon=-95.33&lat=29.78&date=2018-01-01&&dim=0.10&api_key=".concat(API_KEY)).then(function (res) {
    return res.data;
  });
}
...
var img = document.createElement('img');
img.src = (0, _apiCalls.getUpdate)();
_sideBar.sideBar.appendChild(img);
