...
var collection = "collections?page=1&query=office";
function getPosts() {
  ...
  _getPosts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axiosApiUrl.get("/photos?client_id=".concat(API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
  ...
  _getRandom = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return axiosApiUrl.get("/photos/random?client_id=".concat(API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
