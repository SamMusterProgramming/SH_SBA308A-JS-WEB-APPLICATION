...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/apiCalls.js":[function(require,module,exports) {
"use strict";
...
var baseGeneralPhotoURL = "https://api.unsplash.com";
var API_KEY = "_u3Nnmb8WOBfOH7z8aguYw6Gapayz9cKApQ4ZJ_ZMRo";
var axiosGPhotoApiUrl = _axios.default.create({
  baseURL: baseGeneralPhotoURL
});

// AXIOS FOR DOG API
var baseDogURL = "https://api.thedogapi.com/v1";
var DOG_API_KEY = "live_CSz0V7yJwznYJztA3oM9QAs5FVTHIRQUUBDmTbX1e7c2M9NEnw3nxbXUhd1dpEmW";
var axiosDogApiUrl = _axios.default.create({
  baseURL: baseDogURL
});
  ...
  _getPosts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axiosGPhotoApiUrl.get("/photos?client_id=".concat(API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
...
function _getRandom() {
  _getRandom = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return axiosGPhotoApiUrl.get("/photos/random?client_id=".concat(API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
...
function _getBreeds() {
  _getBreeds = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return axiosDogApiUrl.get("/breeds?api_key=".concat(DOG_API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
...
function getDogs(_x) {
  return _getDogs.apply(this, arguments);
}
function _getDogs() {
  _getDogs = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(breed) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return axiosDogApiUrl.get("/images/search?limit=20&breeds=".concat(breed, "?client_id=").concat(DOG_API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
...
exports.selectBreed = exports.favouriteHeart = void 0;
exports.setUpBreedSelector = setUpBreedSelector;
...
var selectBreed = exports.selectBreed = document.querySelector('#breedSelect');
function setUpBreedSelector() {
  (0, _apiCalls.getBreeds)().then(function (data) {
    data.map(function (breed) {
      var breedSelected = document.createElement('option');
      breedSelected.textContent = breed.name;
      selectBreed.appendChild(breedSelected);
    });
  });
}
},{"./apiCalls":"src/apiCalls.js"}],"src/navbar/Links.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/navbar/nav.js":[function(require,module,exports) {
"use strict";
...
exports.setUpTopBar = setUpTopBar;
exports.topBar = void 0;
var _Links = require("./Links.js");
var topBar = exports.topBar = document.querySelector('#topContainer');
var bottomBar = exports.bottomBar = document.querySelector('#bottomContainer');
var color = "white";
function setUpTopBar() {
  _Links.navLinks.forEach(function (link) {
    console.log('i am here ');
    var a = document.createElement('a');
    a.textContent = "".concat(link.text);
...
topBar.addEventListener('mouseover', function (e) {
  ...
  bottomBar.innerHTML = '';
  findSubLink(e.target.text).forEach(function (link) {
    var a = document.createElement('a');
...
},{"./Links.js":"src/navbar/Links.js"}],"src/sideBar/links.js":[function(require,module,exports) {
"use strict";
...
var sideBarLinks = exports.sideBarLinks = [{
  name: 'EARTH',
  src: './asset/images/earth.png',
  href: '/earth'
}, {
  name: 'EARTH',
  src: '../asset/images/earth.png',
  ...
  name: 'EARTH',
  src: '/src/asset/images/earth.png',
  href: '/earth'
}, {
  name: 'EARTH',
  src: './src/asset/images/earth.png',
...
},{}],"src/sideBar/sideBar.js":[function(require,module,exports) {
"use strict";
...
var sideBar = exports.sideBar = document.querySelector('#sideBar');
function setUpSideBar() {
  _links.sideBarLinks.forEach(function (link) {
    var div = document.createElement('div');
    div.setAttribute('class', 'sideBarItem');
    var anchor = document.createElement('a');
    anchor.setAttribute('href', link.href);
    var img = document.createElement('img');
    img.setAttribute('src', "".concat(link.src));
    anchor.appendChild(img);
    div.appendChild(anchor);
    sideBar.appendChild(div);
  });
}
},{"./links":"src/sideBar/links.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
function createPhoto(src) {
  var description = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "unknown";
  var author = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "unknown";
  var div = document.createElement('div');
...
random.addEventListener('click', function (e) {
  clearWrapper();
  displayer.innerHTML = "";
  (0, _apiCalls.getRandom)().then(function (data) {
    console.log(data);
    var img = document.createElement('img');
...
(0, _displayerStaff.setUpBreedSelector)();
_displayerStaff.selectBreed.addEventListener('change', function (e) {
  e.preventDefault();
  (0, _apiCalls.getDogs)(e.target.value).then(function (photos) {
    resetDisplayer();
