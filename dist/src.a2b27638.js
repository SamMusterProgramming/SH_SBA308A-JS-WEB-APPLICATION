...
var API_KEY = 'uzspfFOdKNoTzjnSVZlDg3GNHFU8FBAVMcxbB1Ms';
var baseURL = " https://api.nasa.gov/planetary/earth/assets/&api_key=".concat(API_KEY);
...
function _getUpdate() {
  _getUpdate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _axios.default.get("https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?limit=20&sol=1000&api_key=".concat(API_KEY)).then(function (res) {
            return res.data;
          });
        case 2:
...
(0, _apiCalls.getUpdate)().then(function (data) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39043" + '/');
